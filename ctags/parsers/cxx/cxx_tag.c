...
#define CXX_COMMON_KINDS(_langPrefix, _szMemberDescription, _syncWith)	\
	...
	{ true,  'p', "prototype",  "function prototypes", .syncWith = _syncWith },		\
	...
	{ true,  'x', "externvar",  "external and forward variable declarations", .syncWith = _syncWith }, \
	{ true,  'z', "parameter",  "function parameters inside function definitions", .syncWith = _syncWith }, \
