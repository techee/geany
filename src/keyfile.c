...
static void save_ui_prefs(GKeyFile *config)
{
	...
	g_key_file_set_boolean(config, PACKAGE, "symbols_categorize", ui_prefs.symbols_categorize);
...
static void load_ui_prefs(GKeyFile *config)
{
	...
	ui_prefs.symbols_categorize = utils_get_setting_boolean(config, PACKAGE, "symbols_categorize", TRUE);
